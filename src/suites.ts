...
export const SUITES: Suite[] = [
  ...
  },
  {
    ...
    badge: 'Recomendado',
    descricao:
      'Localizada no térreo com ar-condicionado, frigobar e TV. Configuração ideal com cama de casal (ou queen) mais uma cama de solteiro.',
    comodidades: [
      { icone: 'fa-compress', texto: 'Térreo' },
      { icone: 'fa-bed', texto: '1 cama de casal + 1 de solteiro' },
      { icone: 'fa-snowflake', texto: 'Ar-condicionado' },
    ...
    fotos: [
      { arquivo: Q + 'pousada-fenix-suite-familia-deluxe-cama-1.png', alt: 'Suíte Tripla - Cama de casal, solteiro e frigobar' },
      { arquivo: Q + 'pousada-fenix-suite-familia-deluxe-cama-2.png', alt: 'Suíte Tripla - Estante de madeira, Smart TV e espelho' },
      { arquivo: Q + 'pousada-fenix-suite-familia-deluxe-cama-3.png', alt: 'Suíte Tripla - Camas, ar-condicionado e cortinas' },
      { arquivo: Q + 'pousada-fenix-suite-familia-deluxe-banheiro-1.png', alt: 'Suíte Tripla - Banheiro privativo com pia e box de vidro' },
    ],
    tabelaPrecos: [
